...
import { Package, Star, FolderTree, FileText } from 'lucide-react';
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, idx) => {
          ...
          return (
            <div key={idx} className="bg-white rounded-lg shadow-sm p-6 border border-[#E8E0D5]/30">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-[#E8E0D5]/30">
          ...
          <div className="h-[250px] w-full flex items-center justify-center">
            {mounted ? (
              ...
              <div className="text-sm text-[#888888]">Đang tải biểu đồ...</div>
            )}
          </div>
        </div>
      </div>
