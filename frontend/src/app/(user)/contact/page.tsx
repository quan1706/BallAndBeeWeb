        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${companyInfo.phone}`} className="font-medium hover:text-[#C8954A] transition-colors">
                    {companyInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-medium hover:text-[#C8954A] transition-colors"
                  >
                    {companyInfo.zalo}
                  </a>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-[#E8E0D5]/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-[#1E3A5F]">Nội dung</label>
                <textarea
                  rows={5}
