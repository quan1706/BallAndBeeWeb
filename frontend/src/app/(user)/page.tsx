        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="border-l-4 border-[#C8954A] pl-6">
              <h2 className="heading text-3xl text-[#1E3A5F] mb-4">Về BALLANDBEEHOME</h2>
              ...
              <Link href="/contact" className="text-[#C8954A] flex items-center gap-2 hover:gap-3 transition-all">
